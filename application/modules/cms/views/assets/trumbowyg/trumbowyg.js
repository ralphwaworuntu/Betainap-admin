...
(function (navigator, window, document, $) {
    ...
    var Trumbowyg = function (editorElem, options) {
        ...
        t.svgPath = svgPathOption;

        /**
         * When the button is associated to a empty object
         * fn and title attributes are defined from the button key value
         * $trumbowyg.svgAbsoluteUseHref ? svgPathOption : baseHref
         * For example
         *      foo: {}
         * is equivalent to :
         *      foo: {
            ...
            var t = this,
                ...
                $btn = $('<button/>', {
                    ...
                    html: t.hasSvg && hasIcon ?
                        '<svg><use x="1" xlink:href="' + t.svgPath + '#' + prefix + (btn.ico || btnName).replace(/([A-Z]+)/g, '-$1').toLowerCase() + '"/></svg>' :
