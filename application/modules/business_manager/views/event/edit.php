                ...
                <div class="form-container">
                    ...
                    <div class="list no-hairlines custom-form">
                        ...
                        <div class="step-0-form">
                            ...
                            <h1 class="create-title"><?=_lang("Edit Event")?></h1>

                            <ul>
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input id="autocomplete-stores" type="text" placeholder="<?=_lang("Select Business")?> (*)" class="" value="<?=$event['store_name']?>">
                                            <span class="input-clear-button"></span>
                                            <input type="hidden" id="store_id" value="<?=$event['store_id']?>">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="step-1-form hidden">
                            ...
                            <h1 class="create-title"><?=_lang("Event Location")?></h1>
                        ...
                        <div class="step-2-form hidden">
                            ...
                            <ul>
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input type="text" id="name" placeholder="<?=_lang("Event title")?> (*)" class="" value="<?=$event['name']?>">
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <textarea class="resizable" id="description" placeholder="<?=_lang("Description")?> (*)"><?=$event['description']?></textarea>
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input type="text" id="phone" placeholder="<?=_lang("Phone Number Ex: +1 000-000-000")?>" class="" value="<?=$event['tel']?>">
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input type="text" id="website" placeholder="<?=_lang("Website Ex: http://google.com")?>" class="" value="<?=$event['website']?>">
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input type="text" id="date_b" placeholder="<?=_lang("Date begin")?>" class=""  value="<?=date("Y-m-d",strtotime($event['date_b']))?>">
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="item-content item-input">
                                    <div class="item-inner">
                                        <div class="item-input-wrap">
                                            <input type="text" id="date_e" placeholder="<?=_lang("Date end")?>" class="" value="<?=date("Y-m-d",strtotime($event['date_e']))?>">
                                            <span class="input-clear-button"></span>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-50">
                                    <a class="big-button button button-fill link" id="go-step-3"><?= _lang("Continue") ?> <i
                                                class="mdi <?=Translate::getDir()=="rtl"?"mdi-arrow-right":"mdi-arrow-left"?>"></i></a>
                                </div>
                            </div>
                        </div>
...
$script = $this->load->view('business_manager/event/scripts/edit-script', $data, TRUE);
