                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    valign="top">
                                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                        Thank you for your subscription, your pack is now activated, you
                                                        will find all the information about your subscription pack
                                                        below: <br>
                                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                        <strong>Pack name:</strong> {packName}<br>
                                                        <strong>Subscription period :</strong> {packDuration} Months
                                                        <br>
                                                        <strong>Expires on:</strong> {packExpired}<br>
                                                        <strong>Price:</strong> {packPrice}<br>
                                                        <strong>Payment methods :</strong> {paymentMethod}<br>
                                                        <strong>Bill :</strong> <a href="{billUrl}">See more</a><br>
                                                    </p>
                                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                        Start managing your shops (<a href="{url}">Start</a>)
                                                    </p>
                                                </td>
                                            </tr>
