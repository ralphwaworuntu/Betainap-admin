...
class Payment extends PayPalResourceModel
{
    ...
    /**
     * Credit financing producted to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @param \PayPal\Api\CreditFinancingProducted $credit_financing_producted
     * 
     * @return $this
     */
    public function setCreditFinancingProducted($credit_financing_producted)
    {
        $this->credit_financing_producted = $credit_financing_producted;
        return $this;
    }
     ...
     * Credit financing producted to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @return \PayPal\Api\CreditFinancingProducted
     */
    public function getCreditFinancingProducted()
    {
        return $this->credit_financing_producted;
    }
