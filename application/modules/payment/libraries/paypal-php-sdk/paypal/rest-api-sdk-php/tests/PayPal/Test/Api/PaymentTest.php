...
class PaymentTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSerializationDeserialization()
    {
        ...
        $this->assertNotNull($obj->getCreditFinancingProducted());
    ...
    public function testGetters($obj)
    {
        ...
        $this->assertEquals($obj->getCreditFinancingProducted(), CreditFinancingProductedTest::getObject());
